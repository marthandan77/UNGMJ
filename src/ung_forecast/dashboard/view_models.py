...
def build_forecast_card(record: ForecastRecord) -> ForecastCard:
    ...
    return ForecastCard(
        ...
        lower_probability_pct=100.0 * probabilities.lower_first,
        upper_probability_pct=100.0 * probabilities.upper_first,
        neither_probability_pct=100.0 * probabilities.neither,
        sell_expected_value=forecast.sell_expected_value,
        buy_expected_value=forecast.buy_expected_value,
        confidence_pct=100.0 * forecast.confidence_score,
