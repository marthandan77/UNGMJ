...
| AC-HOR-001..005 | `src/ung_forecast/horizons.py`, `src/ung_forecast/training/session_dataset.py` | `tests/test_foundation.py`, `tests/training/test_session_dataset.py` | IMPLEMENTED |
...
| AC-LABEL-001 | `src/ung_forecast/labels/triple_barrier.py`, `src/ung_forecast/outcomes.py`, `src/ung_forecast/training/session_dataset.py` | `tests/labels/test_barriers_and_labels.py`, `tests/persistence/test_forecast_store_and_scoring.py`, `tests/training/test_session_dataset.py` | IMPLEMENTED |
...
| AC-MODEL-002 | `src/ung_forecast/models/elastic_net.py`, `src/ung_forecast/models/artifacts.py` | `tests/models/test_models.py`, `tests/models/test_artifacts.py` | IMPLEMENTED |
| AC-VAL-001..004 | `src/ung_forecast/validation/walk_forward.py`, `src/ung_forecast/validation/purge.py`, `src/ung_forecast/models/calibration.py`, `src/ung_forecast/training/empirical.py` | `tests/validation/test_walk_forward.py`, `tests/validation/test_label_end_purge.py`, `tests/validation/test_metrics_and_approval.py`, `tests/training/test_empirical_runner.py` | IMPLEMENTED |
| AC-VAL-005..006 | `src/ung_forecast/validation/metrics.py`, `src/ung_forecast/validation/approval.py`, `src/ung_forecast/training/empirical.py` | `tests/validation/test_metrics_and_approval.py`, `tests/training/test_empirical_runner.py` | IMPLEMENTED |
